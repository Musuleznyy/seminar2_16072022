...
При создании новой ветки, необходимо,записать и запомнить её название,что бы в дальнейшем не возникло вопросов у вас и ваших коллег.
Если забыли какую информацию указали в иструкции ,всегда можно посмотреть вернувшись в ветку.

## Удаленные репозитории
Удаленный репозиторий это облачное хранилище моих файлов .Позволяет работать с проектом из любой точки мира где есть доступ к интернет.
